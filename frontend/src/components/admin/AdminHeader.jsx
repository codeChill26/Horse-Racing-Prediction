        ...
        <header className="h-20 bg-surface border-b border-[#30363D] px-8 sticky top-0 z-40 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 min-w-0">
                ...
                <div className="flex items-center gap-3 min-w-0">
                    <h1 className="font-serif text-base md:text-lg font-black text-primary uppercase tracking-wide whitespace-nowrap truncate max-w-[180px] md:max-w-none leading-none">
                        GrandStride
                    </h1>
